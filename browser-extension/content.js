...
function attach(video) {
  ...
  control.innerHTML = '<span>Melhorar vídeo</span><label>Modelo <select class="vu-model"><option value="x2plus">Real-ESRGAN x2 (rápido)</option><option value="animevideo">AnimeVideo x4</option><option value="general">General x4</option><option value="x4plus">Real-ESRGAN x4</option><option value="anime_6B">Anime x4 (qualidade)</option><option value="efrlfn_x2" title="~7x mais rápido, qualidade mais suave">EfRLFN x2 (turbo)</option><option value="efrlfn_x4" title="~5x mais rápido, qualidade mais suave">EfRLFN x4 (turbo)</option><option value="rlfn_x2" title="~6x mais rápido, qualidade próxima ao Real-ESRGAN">RLFN x2 (turbo nítido)</option><option value="rlfn_x4" title="~6x mais rápido, qualidade próxima ao Real-ESRGAN">RLFN x4 (turbo nítido)</option></select></label><button type="button" data-pipeline="native">Prévia</button><button type="button" data-pipeline="native">Processar</button><button type="button" data-pipeline="browser" title="Experimental: processa nesta aba, sem o componente local">No navegador</button>';
